...
class Admin extends BaseController
{
    ...
    public function sendEmailMerah($emailPegawai, $namaPegawai, $namaTraining, $tanggalTraining)
    {
        ...
        $subject = 'Reccurent Training';
        $email->setSubject($subject);

        // pesan tampilan di emailnya
        $body = "
        <center><h1>Hallo, $namaPegawai</h1></center>
        <p>Lisensi pelatihan sudah expired, mohon segera melaksanakan pelatihan <b>$namaTraining</b><br>
        yang bertepat tanggal <b>$tanggalTraining</b>, Cabin Service Team </p><br>
        ";
        $message = $body;
    ...
    public function sendEmailKuning($emailPegawai, $namaPegawai, $namaTraining, $tanggalTraining)
    {
        ...
        $body = "
        <center><h1>Hallo, $namaPegawai</h1></center>
        <p>Lisensi pelatihan sudah mendekat, mohon persiapkan diri untuk pelatihan <b>$namaTraining</b><br>
        yang bertepat tanggal <b>$tanggalTraining</b>, Cabin Service Team </p><br>
        ";
        $message = $body;
        $email->setMessage($message);
